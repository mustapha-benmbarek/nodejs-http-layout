# Node.js : HTTP Layout <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />


### What is in there
This GitHub repository is just a simple web application starter using a layout.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-http-layout
cd nodejs-http-layout
npm install
node index.js
```
